...
public class GATKWGSMetricsGeneratorIntegrationTest extends CommandLineProgramTest {
    ...
    @Test
    public void testGenerateReadGroupSummary() throws Exception {
        final File tempFile = createTempFile("testGATKWGSMetricsGeneratorReadGroupSummary.", ".vcf");
        tempFile.createNewFile();
        IntegrationTestSpec testSpec = new IntegrationTestSpec(
                " -R " + b37_reference_20_21 +
                        " -I " + NA12878_20_21_WGS_bam +
        ...
        testSpec.executeTest("testGATKWGSMetricsGeneratorReadGroupSummary", this);
        final Path expectedFile = TEST_DATA_DIR.resolve("testGATKWGSMetricsGeneratorReadGroupSummary.vcf");
        IntegrationTestSpec.assertEqualTextFiles(tempFile, expectedFile.toFile());
    }
}
